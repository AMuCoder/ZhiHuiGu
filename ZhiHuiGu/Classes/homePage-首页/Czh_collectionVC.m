                   ...
                   QrcodeImage:(NSString *)qrcodeImage
{
    ...
    NSString *pinjieStr2 = [pinjieStr0 stringByAppendingString: currencyStr];
    ...
    _replacementBtn.titleLabel.textAlignment = NSTextAlignmentLeft;
    ...
    _setCountBtn.titleLabel.textAlignment = NSTextAlignmentRight;
