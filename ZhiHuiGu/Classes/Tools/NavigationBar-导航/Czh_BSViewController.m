...
@interface Czh_BSViewController ()

@end

@implementation Czh_BSViewController
...
-(UILabel *)navigationTitleLabel{
    if (!_navigationTitleLabel) {
        _navigationTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, Main_Screen_Width - 150, 30)];
