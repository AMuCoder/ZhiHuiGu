...
@property (nonatomic,copy) void(^failedCallback)(void);
...
//适用于列表页的缓存请求
-(void)GET:(NSString *)url success:(void(^)(NSData *))okCallback failed:(void(^)(void))failCallback isCached:(BOOL)iscache isList:(BOOL)islist currentPage:(NSInteger)page cacheName:(NSString *)cachename;

//POST请求
-(void)POST:(NSString *)url params:(NSDictionary *)params success:(void(^)(NSData *))okCallback failed:(void(^)(void))failCallback;
